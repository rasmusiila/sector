...
@section('content')
    ...
    {{--    <br>--}}
    {{--    <label for="sectors">Sectors:</label>--}}
    {{--    <select multiple="" size="50" id="sectors">--}}
    {{--        --}}{{--        TODO: size was set to 50 for developing, was originally 5--}}
    {{--        @foreach ($sectors as $sector)--}}
    ...
    {{--        --}}{{--        <option value="271">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Aluminium and steel--}}
    {{--        --}}{{--            workboats--}}
    {{--        --}}{{--        </option>--}}
    {{--        --}}{{--        <option value="269">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Boat/Yacht building--}}
    {{--        --}}{{--        </option>--}}
    ...
    {{--        --}}{{--        </option>--}}
    {{--        --}}{{--        <option value="62">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Forgings, Fasteners--}}
    {{--        --}}{{--        </option>--}}
    {{--        --}}{{--        <option value="69">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gas, Plasma, Laser--}}
    {{--        --}}{{--            cutting--}}
    {{--        --}}{{--        </option>--}}
    {{--        --}}{{--        <option value="66">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MIG, TIG, Aluminum--}}
    {{--        --}}{{--            welding--}}
    {{--        --}}{{--        </option>--}}
    ...
    {{--        --}}{{--        <option value="53">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Plastics welding and--}}
    {{--        --}}{{--            processing--}}
    {{--        --}}{{--        </option>--}}
    ...
    {{--        --}}{{--        <option value="581">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data processing, Web portals, E-marketing--}}
    {{--        --}}{{--        </option>--}}
